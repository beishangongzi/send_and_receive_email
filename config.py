...
SEND_EMAIL_HOST_PASSWORD = 'you password' #past the key or password app here
SEND_EMAIL_PORT = 25
...
RECEIVE_EMAIL_HOST_PASSWORD = 'your another password' #past the key or password app here
